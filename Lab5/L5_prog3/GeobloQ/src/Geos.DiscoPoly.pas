...
//-------------------------------------------------------------------
//  pseudo angle and distance that react the same as an exact angle and distance.
// ------------------------------------------------------------------
procedure AngleDistance(p1, p2: TPoint2D; a, d: double);
//-------------------------------------------------------------------
//  points of a quadrilateral that fits inside  the point set.
// -------------------------------------------------------------------
...
(*----------------------------------------------------------------------
   points within a random set of points that make
   up the convex hull of the set of points.
----------------------------------------------------------------------*)
procedure ConvexHull(pointset: xypolygon; nrpnts, nrhpnts: integer);
(*------------------------------------------------------------------------
   determines if a point (Pnt) is inside or outside of a polygon
...
(*---------------------------------------------------------------------------
 returns the length of each side and XY coordinates of each
...
(*-------------------------------------------------------------------------
  determines if the polygon in variable poly is convex, concave or collinear.
--------------------------------------------------------------------------*)
procedure PolygonType(poly: xypolygon; nrpnts: integer; var polytype: integer);

(*------------------------------------------------------------------------
  returns the coordinates of a rectangle (pr) that encloses a polygon (Poly)
-------------------------------------------------------------------------*)
...
(*-------------------------------------------------------------------
  creates a double linked list of points on a polygon in
  dynamic memory.
 --------------------------------------------------------------------*)
