...
(*
  Определение площадей и объёмов
  различных геометрических фигур
*)


unit Geos.DiscoMetric;
...
// Площади
// Площадь right or obtuse triangle
...
// Площадь под циклоидой заданного радиуса (rad) of the generating circle
function AreaCycloid(rad: double): double;
//  Площадь ellipse
function AreaEllipse(majaxis, minaxis: double): double;
//  Площадь fillet or ribbon
