...
type
  TfrmGexoblock = class(TfmInitialForm) // or TForm
    Layer3D1: TLayer3D;
    Layout3D1: TLayout3D;
    Light1: TLight;
...
procedure TfrmGexoblock.DefaultLayout;
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.FormCreate(Sender: TObject);
begin
  inherited;
//  ReadIniFile;
...
procedure TfrmGexoblock.FormShow(Sender: TObject);
begin
  inherited;
  DefaultLayout;
end;
...
//----------------------------- Actions ------------------------------------\\
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acFileExitCanActionExec(Sender: TCustomAction;
  var CanExec: Boolean);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acMethodGridGenerationExecute(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acMethodInterpolationExecute(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acMethodPitOptimizationExecute(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acSaveAsExecute(Sender: TObject);
begin
  //Save As
end;

procedure TfrmGexoblock.acToolsOptionsExecute(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.acHelpAboutExecute(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.ReadIniFile;
var
  StyleID: integer;
begin
  inherited;
  ...
  IniFile := TIniFile.Create(PathExe + 'Geoblok.ini');
  with IniFile do
    try
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.sbCenterClick(Sender: TObject);
begin
  FrameShowTable.Visible := not FrameShowTable.Visible;
end;

//----------------------------------------------------------------------------
procedure TfrmGexoblock.cbMultiViewChange(Sender: TObject);
begin
  FrameDataBrowser.TreeViewData.ShowCheckboxes := cbMultiView.IsChecked;
end;

//----------------------------------------------------------------------------
procedure TfrmGexoblock.sbMultiViewClick(Sender: TObject);
begin
///
end;

//----------------------------------------------------------------------------
procedure TfrmGexoblock.WriteIniFile;
begin
  PathExe := ExtractFilePath(ParamStr(0));
  SetCurrentDir(PathExe);
...
//----------------------------------------------------------------------------
procedure TfrmGexoblock.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  try
