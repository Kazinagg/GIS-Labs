C
      SUBROUTINE DSP3AL(INDSP,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,
...
C
C
      SUBROUTINE DSP3RP(IN,IOUT,NCOL,NROW,NLAY,AL,TRPT,TRPV,DMCOEF)
C ********************************************************************
...
C
C
      SUBROUTINE DSP3CF(IOUT,KSTP,KPER,NCOL,NROW,NLAY,ICBUND,PRSITY,
...
C
C
      SUBROUTINE DSP3SV(NCOL,NROW,NLAY,MCOMP,ICOMP,ICBUND,DELR,DELC,DZ,
...
C
     ...
     &          RMASIO,TMASIO,WXP,WXM,WYP,WYM,WZP,WZM,DCDSP,DELR,DELC,
     ...
     &          DZZ(NCOL,NROW,NLAY),
     &          TMASIO(20,2,MCOMP),RMASIO(20,2,MCOMP),TMASS(4,MCOMP)
C
...
C
C
      SUBROUTINE DSP3FM(NCOL,NROW,NLAY,MCOMP,ICOMP,ICBUND,DELR,DELC,DZ,
...
C
C
      SUBROUTINE DSP3BD(NCOL,NROW,NLAY,MCOMP,ICOMP,ICBUND,DELR,DELC,DH,
     & DXX,DXY,DXZ,DYX,DYY,DYZ,DZX,DZY,DZZ,CNEW,BUFF,DTRANS,
     & TMASIO,RMASIO,TMASS)
C **********************************************************************
...
C
      ...
      INTEGER   NCOL,NROW,NLAY,K,I,J,KP1,KM1,IP1,IM1,JP1,JM1,ICBUND,
     &          MCOMP,ICOMP
      REAL      DCFLUX,DTRANS,BUFF,
     &          RMASIO,TMASIO,WXP,WXM,WYP,WYM,WZP,WZM,DELR,DELC,
     &          DH,DXX,DXY,DXZ,DYX,DYY,DYZ,DZX,DZY,DZZ,CNEW,TMASS
      DIMENSION ICBUND(NCOL,NROW,NLAY,MCOMP),DELR(NCOL),DELC(NROW),
