...
C                     (Version 2.5, February 2003)                    +
C    RT3D (version 2.5) was developed by: Dr. T. Prabhakar Clement    +
...
C RT3D (version-2.5) is based on RT3D (version-1) which was orginally 
C developed by T. Prabhakar Clement at Battelle Pacific Northwest National
C Laboratory.  The current version of RT3D uses several MT3DMS routines 
C (DoD_3.50.A) and several pubic domain NETLIB routines.       
...
C MT3DMS was written by Chunmiao Zheng and P. Patrick Wang
...
C-------EMRL JIG
      ...
      WRITE(*,101)
  101 FORMAT(1x,'RT3D -- Reactive Transport in Three Dimensions',
     & /1x' [Release 2.5  ::  Build 2003-Feb-03]',
     & //1x,' Developed by:  RT3D Development Team',
     & /1x,'  Lead Author:  Dr. Prabhakar Clement'/)
C
...
C--WRITE PROGRAM TITLE TO OUTPUT FILE
   ...
   11 FORMAT(/30X,71('+')/30X,'+',69X,'+'
     &  /30X,'+',28X,'   RT3Dv2.5',30X,'+'
     &  /30X,'+',20X,'A 3D Reactive Transport Model ',
     &           19X,'+'
...
c	result=setexitqq(qwin$exitpersist)
	...
	COMMON /EMRL/PATH,PREFIX
	INTEGER*4 COUNT,COUNT1,INDEX,C1
