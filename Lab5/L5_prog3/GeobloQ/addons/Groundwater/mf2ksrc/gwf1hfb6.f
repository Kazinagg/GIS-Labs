...
C7------------WOULD BE SKIPPED.
     ...
     &                                           BOTM(J2,I2,LBOTM(K)-1)
              if((k.eq.nlay).and.(minthick.gt.0.0))then         !jd
                rrtemp1=hd1-botm(j1,i1,lbotm(k))                !jd
                if(rrtemp1.lt.minthick)rrtemp1=minthick         !jd
                rrtemp2=hd2-botm(j2,i2,lbotm(k))                !jd
                if(rrtemp2.lt.minthick)rrtemp2=minthick         !jd
                thkavg=(rrtemp1+rrtemp2)/2.0                    !jd
              else                                              !jd
