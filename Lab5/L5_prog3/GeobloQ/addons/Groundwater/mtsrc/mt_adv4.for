C
      SUBROUTINE ADV4AL(INADV,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,MCOMP,
...
C--PRINT PACKAGE NAME AND VERSION NUMBER
 ...
 1030 FORMAT(1X,'ADV4 -- ADVECTION PACKAGE,',
...
C
C
      SUBROUTINE ADV4RP(IN,IOUT,NCOL,NROW,NLAY,MCOMP,MIXELM,
...
C
C
      SUBROUTINE ADV4SV(IOUT,NCOL,NROW,NLAY,MCOMP,ICOMP,MIXELM,MXPART,
...
C--IF FINITE DIFFERENCE OR ULTIMATE OPTION IS USED
      IF(MIXELM.EQ.0) THEN
        CALL SADV4F(NCOL,NROW,NLAY,ICBUND(1,1,1,ICOMP),DELR,DELC,DH,
     &   PRSITY,CNEW(1,1,1,ICOMP),COLD(1,1,1,ICOMP),QX,QY,QZ,
     &   RETA(1,1,1,ICOMP),DTRANS,RMASIO(1,1,ICOMP))
      ELSEIF(MIXELM.EQ.-1) THEN
        CALL SADV4U(NCOL,NROW,NLAY,ICBUND(1,1,1,ICOMP),DELR,DELC,DH,
...
C--CALCULATE CNEW WITH FORWARD TRACKING PROCEDURE
        CALL SADV4M(NCOL,NROW,NLAY,MXPART,NCOUNT(ICOMP),
...
C--CALCULATE CNEW WITH BACKWARD TRACKING PROCEDURE
      IF(MIXELM.EQ.2 .OR. MIXELM.EQ.3) THEN
        CALL SADV4B(NCOL,NROW,NLAY,MIXELM,
      ...
      DO K=1,NLAY
        DO I=1,NROW
          DO J=1,NCOL
            ...
            QCTMP=SADV4Q(NCOL,NROW,NLAY,J,I,K,ICBUND(1,1,1,ICOMP),
...
C
C
      SUBROUTINE SADV4M(NCOL,NROW,NLAY,MXPART,NCOUNT,NPCHEK,XP,YP,ZP,
...
C
C
      SUBROUTINE SADV4B(NCOL,NROW,NLAY,MIXELM,ICBUND,DELR,DELC,DZ,
...
C
C
      FUNCTION SADV4Q(NCOL,NROW,NLAY,JJ,II,KK,ICBUND,DELR,DELC,DH,
...
C MOVING OUT OF THE CELL IF SADV4Q > 0, INTO THE CELL IF SADV4Q < 0.
...
C
      ...
      REAL      SADV4Q,COLD,QX,QY,QZ,DELR,DELC,DH,AREA,DTRANS,QCTMP,
...
C
C
      SUBROUTINE SADV4F(NCOL,NROW,NLAY,ICBUND,DELR,DELC,DH,PRSITY,
...
C
C
      SUBROUTINE ADV4FM(NCOL,NROW,NLAY,MCOMP,ICOMP,ICBUND,DELR,DELC,DH,
...
C
C
      SUBROUTINE ADV4BD(IOUT,NCOL,NROW,NLAY,MCOMP,ICOMP,NADVFD,
...
C
C
      SUBROUTINE SADV4U(NCOL,NROW,NLAY,ICBUND,DELR,DELC,DH,PRSITY,
