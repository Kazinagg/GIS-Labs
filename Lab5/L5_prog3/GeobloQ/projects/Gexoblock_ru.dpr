...
uses
  ...
  fxToolsOptions in '..\sourcex\fxToolsOptions.pas' {frmToolsOptions},
  ...
  fxInterpolation in '..\sourcex\fxInterpolation.pas' {FormInterpolation},
  fxGridGeneration in '..\sourcex\fxGridGeneration.pas' {FormGridGeneration},
  ...
  fxPitOptimization in '..\sourcex\fxPitOptimization.pas' {FormPitOptimization},
  ...
  fxGexoblock_ru in '..\sourcex\fxGexoblock_ru.pas' {fmGexoblock};
...
begin
  ...
  Application.CreateForm(TfmGexoblock, fmGexoblock);
