...
type
  TFormDrawLineStyle = class(TFormBlankDialog)
...
var
  FormDrawLineStyle: TFormDrawLineStyle;
...
procedure TFormDrawLineStyle.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFormDrawLineStyle.ComboBoxLineTypeChange(Sender: TObject);
begin
...
procedure TFormDrawLineStyle.EditWidthChange(Sender: TObject);
var
  LW, Code: integer;
begin
...
procedure TFormDrawLineStyle.ImageColorClick(Sender: TObject);
begin
  PanelColor.SetFocus;
...
procedure TFormDrawLineStyle.ComboBoxLineTypeDrawItem(Control: TWinControl;
  Index: integer; Rect: TRect; State: TOwnerDrawState);
var
  Bmap: TBiTMap;
  R:    TRect;
...
constructor TFormDrawLineStyle.CreateServiceLines(Width: integer;
...
procedure TFormDrawLineStyle.ExampleDraw;
var
  vPen: TPen;
begin
  vPen := TPen.Create;
...
procedure TFormDrawLineStyle.PanelColorEnter(Sender: TObject);
begin
  with ImageColor.Canvas do
  begin
...
procedure TFormDrawLineStyle.PanelColorExit(Sender: TObject);
begin
  with ImageColor.Canvas do
  begin
    DrawFocusRect(Rect(0, 0, ImageColor.Width, ImageColor.Height));
...
procedure TFormDrawLineStyle.SpinEditWidthChange(Sender: TObject);
var
  LW, Code: integer;
begin
  Val(SpinEditWidth.Text, LW, Code);
...
procedure TFormDrawLineStyle.SpinEditWidthExit(Sender: TObject);
var
  LW:   integer;
  Code: integer;
begin
...
procedure TFormDrawLineStyle.SpinEditWidthKeyPress(Sender: TObject; var Key: char);
begin
