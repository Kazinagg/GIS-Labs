...
type
  TFormMethodTransformation = class(TFormMethodDialog)
...
var
  FormMethodTransformation: TFormMethodTransformation;
...
procedure TFormMethodTransformation.RadioGroupModeClick(Sender: TObject);
begin
...
procedure TFormMethodTransformation.ButtonResetClick(Sender: TObject);
var
  I, J: integer;
begin
...
procedure TFormMethodTransformation.Transform(Table: TTable);
const
  X = 0;
  Y = 1;
  Z = 2;
...
procedure TFormMethodTransformation.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
  RadioGroupModeClick(Self);
...
procedure TFormMethodTransformation.DoUpdate(Sender: TObject);
begin
  with Sender as TGBEditValue do
    Matrix.V[Tag div 4].V[Tag mod 4] := asDouble;
end;

procedure TFormMethodTransformation.UpdateEditValue;
var
  I, J: byte;
...
procedure TFormMethodTransformation.ButtonTransferClick(Sender: TObject);
var
...
procedure TFormMethodTransformation.ButtonRotateClick(Sender: TObject);
var
  V: array[0..2] of double;
  AffineDblVector: TAffineDblVector;
  AffineFltVector: TAffineFltVector;
...
procedure TFormMethodTransformation.ButtonScaleClick(Sender: TObject);
var
  V: array[0..2] of double;
  AffineDblVector: TAffineDblVector;
  AffineFltVector: TAffineFltVector;
...
procedure TFormMethodTransformation.EditMatrixChange(Sender: TObject);
begin
  if Assigned(FOnUpdate) then
    FOnUpdate(Sender);
end;

procedure TFormMethodTransformation.ButtonOKClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodTransformation.ReadIniFile;
begin
...
procedure TFormMethodTransformation.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodTransformation.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;

procedure TFormMethodTransformation.ListBoxInputNamesClick(Sender: TObject);
begin
  inherited;
