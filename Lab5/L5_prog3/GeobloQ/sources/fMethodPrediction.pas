...
type
  TFormMethodPrediction = class(TFormMethodDialog)
...
var
  FormMethodPrediction: TFormMethodPrediction;
...
procedure TFormMethodPrediction.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
  SetSizeClasses;
...
procedure TFormMethodPrediction.SetGradeClasses;
var
  I: integer;
  Lev1, Lev2: integer;
begin
...
procedure TFormMethodPrediction.SetSizeClasses;
var
  I: integer;
...
procedure TFormMethodPrediction.SpeedButtonPowerClick(Sender: TObject);
begin
  SetSizeClasses;
end;

procedure TFormMethodPrediction.SpeedButtonASTMClick(Sender: TObject);
begin
  SetSizeClasses;
end;

procedure TFormMethodPrediction.SpeedButtonUniformClick(Sender: TObject);
begin
  SetGradeClasses;
end;

procedure TFormMethodPrediction.SpeedButtonLognormClick(Sender: TObject);
begin
  SetGradeClasses;
end;

procedure TFormMethodPrediction.ValsFromDialog;
var
  I: integer;
begin
...
function TFormMethodPrediction.Prediction: boolean;
...
procedure TFormMethodPrediction.ButtonOKClick(Sender: TObject);
...
procedure TFormMethodPrediction.ReadIniFile;
begin
...
procedure TFormMethodPrediction.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodPrediction.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;
