...
procedure TFormMethodInterpolation.FormClose(Sender: TObject;
...
procedure TFormMethodInterpolation.ToolButtonInputBClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodInterpolation.ListBoxInputNamesBClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodInterpolation.RadioGroupMethodClick(Sender: TObject);
begin
{
...
procedure TFormMethodInterpolation.ButtonOptionsClick(Sender: TObject);
begin
  case RadioGroupMethod.ItemIndex of
    imInverseDistances:
      begin
...
procedure TFormMethodInterpolation.Interpolate(TablePoints, TableNodes:TTable);
...
procedure TFormMethodInterpolation.ListBoxInputNamesClick(Sender: TObject);
begin
  inherited;
  ReadGridParameters;
end;
...
procedure TFormMethodInterpolation.ToolButtonInputClick(Sender: TObject);
begin
  inherited;
  ReadGridParameters;
end;
...
procedure TFormMethodInterpolation.ButtonOKClick(Sender: TObject);
var
  I: integer;
begin
  inherited;
