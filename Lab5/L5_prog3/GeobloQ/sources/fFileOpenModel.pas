...
type
  TFormFileOpenModel = class(TfmFileOpenDialog)
...
var
  FormFileOpenModel: TFormFileOpenModel;
...
function TFormFileOpenModel.GetPathFromTag(ATabSheetTag: integer): string;
begin
...
procedure TFormFileOpenModel.PageControlChange(Sender: TObject);
begin
  inherited;
  GetPathFromTag(PageControl.ActivePage.Tag);
end;

function TFormFileOpenModel.GetModelType: integer;
begin
