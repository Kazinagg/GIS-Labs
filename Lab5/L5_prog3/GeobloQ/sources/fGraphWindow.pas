...
type
  TfrmGraphWindow = class(TFormFirst)
    ToolBar:    TToolBar;
...
procedure TfrmGraphWindow.ComboBoxXFieldChange(Sender: TObject);
begin
...
procedure TfrmGraphWindow.ToolButtonCloseClick(Sender: TObject);
begin
  Close;
end;
...
procedure TfrmGraphWindow.ToolButtonPrintClick(Sender: TObject);
begin
...
procedure TfrmGraphWindow.SpeedButtonGraphTypeClick(Sender: TObject);
var
  P: TPoint;
begin
...
procedure TfrmGraphWindow.SpeedButtonCurveTypeClick(Sender: TObject);
var
  P: TPoint;
begin
...
procedure TfrmGraphWindow.FormActivate(Sender: TObject);
begin
  FormGeoblock.EditCopy.Enabled  := True;
  FormGeoblock.EditPaste.Enabled := True;
end;

procedure TfrmGraphWindow.FormDeactivate(Sender: TObject);
begin
  FormGeoblock.EditCopy.Enabled  := False;
  FormGeoblock.EditPaste.Enabled := False;
end;

procedure TfrmGraphWindow.CopyToClipboard;
begin
  DBChart.CopyToClipBoardMetafile(True);
end;

procedure TfrmGraphWindow.GetWorkFields;
var
  I: integer;
begin
...
procedure TfrmGraphWindow.OpenTable(ATableName: string);
begin
...
procedure TfrmGraphWindow.ReadIniFile;
begin
...
procedure TfrmGraphWindow.SetSeries;
var
  I, N: integer;
...
procedure TfrmGraphWindow.MenuItemGraphTypeClick(Sender: TObject);
begin
  Screen.Cursor := crHourGlass;
...
procedure TfrmGraphWindow.CheckBoxLegendClick(Sender: TObject);
begin
...
procedure TfrmGraphWindow.CheckBoxView3DClick(Sender: TObject);
begin
...
procedure TfrmGraphWindow.ToolButtonProfilogramClick(Sender: TObject);
begin
  CheckListBoxYFields.Enabled := True;
end;

procedure TfrmGraphWindow.ToolButtonHistogramClick(Sender: TObject);
begin
  CheckListBoxYFields.Enabled := False;
end;

procedure TfrmGraphWindow.CheckListBoxYFieldsClick(Sender: TObject);
begin
  Screen.Cursor := crHourGlass;
  try
    SetSeries;
...
procedure TfrmGraphWindow.UnCheckedItems(Menu: TMenu);
var
  I: integer;
begin
...
procedure TfrmGraphWindow.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
