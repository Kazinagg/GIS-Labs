...
type
  TfmOptionDialog = class(TFormBlankDialog)
...
begin
  ...
  frmMapWindow.Model.Attributes.AttributeByName(SelectedField).LegendDialog;
  frmMapWindow.Model.ActiveAttributeNo :=
    frmMapWindow.Model.Attributes.AttributeByName(SelectedField).Index;
  frmMapWindow.Model.Update;
end;
...
begin
  case RadioGroupDetails.ItemIndex of
    ...
    begin  // Points
      ...
      CheckBoxAsCylinder.Enabled := False;
      CheckBoxAsCylinder.Checked := False;
      frmMapWindow.Model.DrawMode := dmPoint;
    end;
    1:
    begin  //Lines
      CheckBoxAsSphere.Enabled   := False;
      CheckBoxAsCylinder.Enabled := True;
      CheckBoxAsSphere.Checked   := False;
      frmMapWindow.Model.DrawMode := dmLine;
    end;
    2:
    begin //Fills
      CheckBoxAsSphere.Enabled   := False;
      ...
      CheckBoxAsSphere.Checked   := False;
      CheckBoxAsCylinder.Checked := False;
      frmMapWindow.Model.DrawMode := dmFill;
    end;
  end;
  if ListBoxNumericAttributes.ItemIndex <> -1 then
