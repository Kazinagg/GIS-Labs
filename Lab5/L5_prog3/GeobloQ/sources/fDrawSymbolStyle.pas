...
type
  TFormDrawSymbolStyle = class(TFormBlankDialog)
...
var
  FormDrawSymbolStyle: TFormDrawSymbolStyle;
...
procedure TFormDrawSymbolStyle.ComboBoxFontChange(Sender: TObject);
var
  I, J: integer;
begin
...
procedure TFormDrawSymbolStyle.StringGridSymbolsSelectCell(Sender: TObject;
  ACol, ARow: integer; var CanSelect: boolean);
begin
...
procedure TFormDrawSymbolStyle.SpinEditSizeChange(Sender: TObject);
begin
  SymbolOptions.Size := SpinEditSize.Value;
  ExampleDraw(SymbolOptions.Symbol);
end;

procedure TFormDrawSymbolStyle.ImageColorClick(Sender: TObject);
begin
  PanelColor.SetFocus;
...
procedure TFormDrawSymbolStyle.PanelColorEnter(Sender: TObject);
begin
  with ImageColor.Canvas do
  begin
...
procedure TFormDrawSymbolStyle.FormCreate(Sender: TObject);
var
  I, J: integer;
...
procedure TFormDrawSymbolStyle.ExampleDraw(S: string);
begin
