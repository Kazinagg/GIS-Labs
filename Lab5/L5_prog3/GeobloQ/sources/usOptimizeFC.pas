...
(*
 Floating Cone method for calculating Ultimate PIT outlines

 The deposit is divided into three-dimensional array
...
function OptimizeFC(var InBlocks: TCoordinateArray;
...
(*
{25:}  if (k >= numz) then goto label400 { print results}
     else
     Inc(k); //k++;
