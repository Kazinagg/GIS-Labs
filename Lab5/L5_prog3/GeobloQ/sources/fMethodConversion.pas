...
type
  TFormMethodConversion = class(TFormMethodDialog)
...
var
  FormMethodConversion: TFormMethodConversion;
...
procedure TFormMethodConversion.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
  EnableOutputButtons;
...
procedure TFormMethodConversion.ToolButtonInputClick(Sender: TObject);
var
  I: integer;
begin
  inherited;
...
procedure TFormMethodConversion.EnableOutputButtons;
var
  I: integer;
begin
...
procedure TFormMethodConversion.ToolButtonOutputClick(Sender: TObject);
var
  I: integer;
begin
...
procedure TFormMethodConversion.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;
...
procedure TFormMethodConversion.ReadIniFile;
begin
...
procedure TFormMethodConversion.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodConversion.EditOutNameChange(Sender: TObject);
begin
  OutModelName := PanelOutPath.Caption + EditOutName.Text;
end;

procedure TFormMethodConversion.SpeedButtonOutputBrowseClick(Sender: TObject);
begin
  with dmDialogs do
  begin
 ...
 //-----------------------------------------------------------------\\
procedure TFormMethodConversion.ConvertTinToMesh2D(
...
//==============================================================\\
procedure TFormMethodConversion.ConvertGrid3D_Grid2D(SourceName, DestName: TFileName;
  ProgressBar: TProgressBar);
...
procedure TFormMethodConversion.ConvertMesh2DToSolids(
...
begin
 ...
 //============================================\\
procedure TFormMethodConversion.ConvertMesh3D_Solids(SourceName, DestName: TFileName;
  ProgressBar: TProgressBar);
...
//----------------------------------------------------------\\
procedure TFormMethodConversion.Conversion;
var
  OldCursor: TCursor;
...
procedure TFormMethodConversion.ButtonOKClick(Sender: TObject);
