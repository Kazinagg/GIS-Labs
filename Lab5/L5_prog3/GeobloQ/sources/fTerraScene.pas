...
type
  TGeoSceneTextureDialog = class(TFormDrawFillStyle)
    aLabel: TLabel;
...
begin
  ...
  aLabel.Left := 10;
  aLabel.Caption := 'Current texture is:' + ' #' + IntToStr(CurrentTexture);
