...
type
  TFormFileImport = class(TFormBlankDialog)
...
var
  FormFileImport: TFormFileImport;
  ProgressBar: TProgressBar;
...
procedure TFormFileImport.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
...
function TFormFileImport.GetOutputPath: TFileName;
begin
  Result := ExtractFilePath(OutModelName);
end;

// -----------------------------------------------------------------------------
function TFormFileImport.ChooseModelType: Boolean;
var
  FileExt: string;
...
procedure TFormFileImport.SetOutModelType(const Value: Integer);
begin
  FOutModelType := Value;
...
procedure TFormFileImport.SetOutModelName(const Value: TFileName);
begin
  FOutModelName := Value;
end;
...
procedure TFormFileImport.SetOutputPath(const Value: TFileName);
begin
...
procedure TFormFileImport.SetInFile(const Value: TFileName);
begin
...
procedure TFormFileImport.CreateMineSequenceTable;
begin
  with dmBase do
  begin
...
{ **************************************************** }
procedure TFormFileImport.DXF_To_Poly(FileNameDXF, FileNamePoly: TFileName);
const
...
function TFormFileImport.FeMapINP_Mesh3D(InFile, OutModelName: TFileName)
  : Integer;
...
procedure TFormFileImport.GRD_To_Grid2D;
var
  F: System.Text;
  K: Longint;
  NR: Integer;
...
procedure TFormFileImport.KDR_To_Poly(FileNameKDR, TableNamePoly: TFileName);
const
  WaitName = 1;
  WaitXYZ = 2;
var
...
{ ****************************************** }
procedure TFormFileImport.MIF_To_Poly(FileNameMIF, FileNamePoly: TFileName);
type
...
// -----------------------------------------------------------------------------
procedure TFormFileImport.DAT_To_Points2D;
var
  F: Textfile;
  Fch: Textfile;
  I, K: Longint;
...
procedure TFormFileImport.MOD_To_Grid3D;
type
  TString2 = string[2];
var
...
procedure TFormFileImport.MSQ_To_Grid3D;
type
  TString2 = string[2];
var
  ParFileName: TFileName;
...
procedure TFormFileImport.ECO_Or_RES_To_Grid3D;
var
  ParFileName: TFileName;
  F1, F2: System.Text;
  K: Longint;
...
// -----------------------------------------------------------------------------
procedure TFormFileImport.EAS_To_Points2D;
var
  F: Textfile;
  S, St: string;
...
// -----------------------------------------------------------------------------
procedure TFormFileImport.ReadIniFile;
begin
...
procedure TFormFileImport.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormFileImport.EditOutputNameChange(Sender: TObject);
begin
...
procedure TFormFileImport.ToolButtonShowAsClick(Sender: TObject);
begin
...
procedure TFormFileImport.FormDestroy(Sender: TObject);
begin
...
procedure TFormFileImport.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;
...
procedure TFormFileImport.ButtonOKClick(Sender: TObject);
