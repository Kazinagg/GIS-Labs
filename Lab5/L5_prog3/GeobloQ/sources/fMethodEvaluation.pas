...
type
  TFormMethodEvaluation = class(TFormMethodDialog)
...
var
  FormMethodEvaluation: TFormMethodEvaluation;
...
procedure TFormMethodEvaluation.Evaluate;
var
  Query: TQuery;
  I:     integer;
...
procedure TFormMethodEvaluation.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
...
procedure TFormMethodEvaluation.ReadIniFile;
begin
...
procedure TFormMethodEvaluation.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodEvaluation.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;

procedure TFormMethodEvaluation.ButtonOKClick(Sender: TObject);
begin
  inherited;
  Evaluate;
end;
