...
type
  TFormFileExport = class(TFormBlankDialog)
...
var
  FormFileExport: TFormFileExport;
...
procedure TFormFileExport.DBTable_AsciiTXT;
var
  FileTxt: System.Text;
  I: integer;
  J: longint;
...
function TFormFileExport.GetOutputFile: string;
begin
  Result := SlashSep(FOutputPath, FOutputName);
end;

function TFormFileExport.GetOutputName: string;
begin
  Result := FOutputName;
end;

function TFormFileExport.GetSourceFile: string;
begin
  Result := dmBase.TableExport.TableName;
end;

procedure TFormFileExport.Grid2D_SurferGRD;
...
procedure TFormFileExport.Grid3D_4XMOD;
type
  TString4 = string
...
procedure TFormFileExport.Grid3D_MeshFeMAP;
var
  F:    System.Text;
  I:    integer;
  J, K: longint;
...
procedure TFormFileExport.Points2D_To_DAT;
var
  FileTxt: System.Text;
  I: integer;
  J: longint;
...
procedure TFormFileExport.Polygons_DXF;
begin
  ShowMessage('Not implemented');  // not implemented
end;

procedure TFormFileExport.SetOutputFile(const Value: string);
begin
...
procedure TFormFileExport.SetOutputName(const Value: string);
begin
...
procedure TFormFileExport.SetSourceFile(const Value: string);
begin
...
procedure TFormFileExport.SpeedButtonBrowseClick(Sender: TObject);
begin
  with dmDialogs do
  begin
...
procedure TFormFileExport.FormActivate(Sender: TObject);
begin
...
procedure TFormFileExport.ButtonOKClick(Sender: TObject);
begin
...
procedure TFormFileExport.ComboBoxTypeChange(Sender: TObject);
begin
  PanelOutputPath.Caption := FOutputPath;
...
procedure TFormFileExport.EditOutputNameChange(Sender: TObject);
begin
