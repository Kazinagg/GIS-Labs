...
//------------------------------------------------------------------------------
(* Parameters of methods for open pit optimization *)
...
type
  TFormMethodPitOptimization = class(TFormMethodDialog)
...
procedure TFormMethodPitOptimization.Optimize;
begin
...
procedure TFormMethodPitOptimization.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
...
procedure TFormMethodPitOptimization.ListBoxInputNamesClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodPitOptimization.RadioGroupMethodClick(Sender: TObject);
begin
  S2 := S1;
  case RadioGroupMethod.ItemIndex of
...
procedure TFormMethodPitOptimization.ReadIniFile;
begin
...
procedure TFormMethodPitOptimization.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodPitOptimization.FormClose(Sender: TObject;
...
procedure TFormMethodPitOptimization.ButtonOKClick(Sender: TObject);
begin
  inherited;
  Optimize;
end;
