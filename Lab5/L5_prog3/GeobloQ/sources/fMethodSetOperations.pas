...
type
  TFormMethodSetOperations = class(TfmMethodDualDialog)
...
var
  FormMethodSetOperations: TFormMethodSetOperations;
...
procedure TFormMethodSetOperations.ToolButtonInputClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodSetOperations.ToolButtonInputBClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodSetOperations.ListBoxInputNamesClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodSetOperations.ListBoxInputNamesBClick(Sender: TObject);
begin
  inherited;
  RadioGroupOperationClick(Sender);
...
procedure TFormMethodSetOperations.RadioGroupOperationClick(Sender: TObject);
begin
  EditOutName.Text := '';
  with dmBase do
...
// ------------------- Dholes ---------------------\\
procedure TFormMethodSetOperations.Dholes_Int_Grid3D;
var
  I: integer;
begin
...
procedure TFormMethodSetOperations.Dholes_Uni_Polygons;
var
  I: integer;
begin
  for I := 0 to dmBase.TableInput.RecordCount - 1 do
...
procedure TFormMethodSetOperations.MoveRecordFromTo(TableSource, TableDest: TTable);
var
  I:      integer;
  Buffer: PChar;
begin
...
procedure TFormMethodSetOperations.Points_Points;
var
  I, J: integer;
...
procedure TFormMethodSetOperations.Points2D_Polygons;
var
  I, J:  integer;
...
procedure TFormMethodSetOperations.Grid2D_Int_Grid2D;
begin
end;
...
procedure TFormMethodSetOperations.Grid2D_Uni_Grid2D;
var
  I:     integer;
...
procedure TFormMethodSetOperations.Grid3D_Int_Grid3D;
begin
  //TODO 1 -oVassiliev 2 -cSet Operation: Intersection of 3D Grids.
end;

procedure TFormMethodSetOperations.Grid3D_Uni_Grid3D;
begin
...
procedure TFormMethodSetOperations.Polygons_Int_Dholes(TablePolygons, TableHoles: TTable);
...
begin //body
 ...
 //-----------------------------------------------------------------------\\
procedure TFormMethodSetOperations.Polygons_Uni_Points2D;
begin
 ...
 //   with calculated avarage real and integer values
 //-----------------------------------------------------------------------\\
procedure TFormMethodSetOperations.Polygons_Int_Points2D;
var
  I, J:    integer;
  Xp, Yp, Zp: array of single;
  Point:   array[0..2] of single;
...
(*---------------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------*)
procedure TFormMethodSetOperations.Tin_Uni_Tin;
var
  I, J: integer;
...
begin
 ...
 //-----------------------------------------------------------------------\\
procedure TFormMethodSetOperations.Mesh2D_Uni_Tin;
var
  I, J, K: integer;
...
function TFormMethodSetOperations.ExecuteOperations: boolean;
begin
  with dmBase do
  begin
...
procedure TFormMethodSetOperations.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
  ListBoxRealAttribute.ItemIndex  := -1;
...
procedure TFormMethodSetOperations.ReadIniFile;
begin
...
procedure TFormMethodSetOperations.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodSetOperations.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;

procedure TFormMethodSetOperations.ButtonOKClick(Sender: TObject);
begin
  inherited;
