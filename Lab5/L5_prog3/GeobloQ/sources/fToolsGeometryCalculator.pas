...
type
  TFormToolsGeometryCalculator = class(TFormPageDialog)
...
var
  FormToolsGeometryCalculator: TFormToolsGeometryCalculator;
...
procedure TFormToolsGeometryCalculator.SetStringGridHeadings;
begin
...
procedure TFormToolsGeometryCalculator.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFormToolsGeometryCalculator.PageControlChange(Sender: TObject);
begin
...
//--------------------------Sphere----------------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleSphereChange(Sender: TObject);
begin
...
//----------------------------Toroid----------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleToroidChange(Sender: TObject);
begin
...
//------------------------Cone----------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleConeChange(Sender: TObject);
begin
...
//------------------------Cylinder----------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleCylinderChange(Sender: TObject);
begin
...
//---------------------------Ellipse----------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleEllipseChange(Sender: TObject);
begin
...
//----------------------------Polygon-------------------------------\\
procedure TFormToolsGeometryCalculator.EditScalePolygonChange(Sender: TObject);
var
  I: integer;
...
//---------------------------Rectangle------------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleRectangleChange(Sender: TObject);
begin
...
//-------------------------Parallelepiped-----------------------\\
procedure TFormToolsGeometryCalculator.EditScaleParallelepipedChange(Sender: TObject);
begin
...
//-----------------------SphereSegment-------------------------\\
procedure TFormToolsGeometryCalculator.EditValueSegmentChange(Sender: TObject);
begin
...
//-------------------------- Prism--------------------------------\\
procedure TFormToolsGeometryCalculator.EditValuePrismChange(Sender: TObject);
begin
...
//--------------------------- Pyramid---------------------------------\\
procedure TFormToolsGeometryCalculator.EditValuePyramidChange(Sender: TObject);
begin
...
//--------------------------Circle---------------------------------\\
procedure TFormToolsGeometryCalculator.EditScaleDoubleCircleRadiusChange(
  Sender: TObject);
begin
...
procedure TFormToolsGeometryCalculator.EditScaleDoubleCircleDiameterChange(
  Sender: TObject);
begin
...
procedure TFormToolsGeometryCalculator.SpeedButtonCopyClick(Sender: TObject);
begin
