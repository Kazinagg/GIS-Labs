...
type
  TFormMethodGridGeneration = class(TFormMethodDialog)
...
procedure TFormMethodGridGeneration.DefaultValues;
begin
  XO := 0;
  YO := 0;
  ZO := 0;
...
procedure TFormMethodGridGeneration.ListBoxInputNamesClick(Sender: TObject);
begin
  inherited;
...
procedure TFormMethodGridGeneration.SpeedButtonBoundsClick(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.ToolButtonInputClick(Sender: TObject);
begin
  inherited;
  InitControls;
...
procedure TFormMethodGridGeneration.InitControls;
begin
  case InModelType of
    mtPoints2D:
    begin
...
procedure TFormMethodGridGeneration.InitModelSize(const XO, YO, ZO, DX, DY, DZ: double;
  const NX, NY, NZ: integer);
begin
...
procedure TFormMethodGridGeneration.SpeedButtonResetClick(Sender: TObject);
begin
  DefaultValues;
  InitModelSize(XO, YO, ZO, DX, DY, DZ, NX, NY, NZ);
  UpdateBlockSizes;
...
procedure TFormMethodGridGeneration.SpeedButtonOutputBrowseClick(Sender: TObject);
begin
  with dmDialogs do
  begin
...
procedure TFormMethodGridGeneration.SpeedButtonSaveBoundsClick(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.ReadIniFile;
begin
...
procedure TFormMethodGridGeneration.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
...
procedure TFormMethodGridGeneration.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  WriteIniFile;
  inherited;
end;

procedure TFormMethodGridGeneration.EditValueXOChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueYOChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueZOChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueXEChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueYEChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueZEChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueDXChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueDYChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.EditValueDZChange(Sender: TObject);
begin
...
procedure TFormMethodGridGeneration.SpinEditNXChange(Sender: TObject);
begin
  NX := SpinEditNX.Value;
  if not InUpdate then
  begin
...
procedure TFormMethodGridGeneration.SpinEditNYChange(Sender: TObject);
begin
  NY := SpinEditNX.Value;
  if not InUpdate then
  begin
...
procedure TFormMethodGridGeneration.SpinEditNZChange(Sender: TObject);
begin
  if ToolButtonPoints2D.Down then
    NZ := 1
  else
...
procedure TFormMethodGridGeneration.UpdateBlockNumbers;
begin
...
procedure TFormMethodGridGeneration.UpdateBlockSizes;
begin
...
procedure TFormMethodGridGeneration.BeginUpdate;
begin
  Inc(FUpdateCount);
end;

procedure TFormMethodGridGeneration.EndUpdate;
begin
  FUpdateCount := Max(0, FUpdateCount - 1);
end;

function TFormMethodGridGeneration.GetInUpdate: boolean;
begin
  Result := boolean(FUpdateCount);
end;

procedure TFormMethodGridGeneration.SetInUpdate(Value: boolean);
begin
  case Value of
    False: EndUpdate;
    True: BeginUpdate;
...
procedure TFormMethodGridGeneration.MakeGrid(AFileName: TFileName;
...
procedure TFormMethodGridGeneration.ButtonOKClick(Sender: TObject);
begin
  inherited;
