...
type
  TfrmFileDataBrowser = class(TFormFirst)
    PanelTop: TPanel;
    PanelMiddle: TPanel;
    PanelBottom: TPanel;
...
var
  frmFileDataBrowser: TfrmFileDataBrowser;
...
procedure TfrmFileDataBrowser.FormCreate(Sender: TObject);
var
  I: Integer;
begin
  inherited;
...
procedure TfrmFileDataBrowser.GetDirectories(Tree: TTreeView; Directory: string;
  Item: TTreeNode; IncludeFiles: Boolean);
var
...
procedure TfrmFileDataBrowser.FillFilesTreeView(const aTreeView: TTreeView;
  const ADir: string);
var
...
procedure TfrmFileDataBrowser.RecursionFillFilesTreeView(const aTreeView
...
procedure TfrmFileDataBrowser.AddDirectories(theNode: TTreeNode; cPath: string);
var
  sr: TSearchRec;
  FileAttrs: integer;
...
procedure TfrmFileDataBrowser.tbExpandClick(Sender: TObject);
begin
  inherited;
  TreeView.FullExpand;
end;

procedure TfrmFileDataBrowser.tbCollapseClick(Sender: TObject);
begin
  inherited;
  TreeView.FullCollapse;
end;

procedure TfrmFileDataBrowser.TreeViewClick(Sender: TObject);
begin
  inherited;
  //
end;

procedure TfrmFileDataBrowser.ReadIniFile;
begin
...
procedure TfrmFileDataBrowser.WriteIniFile;
begin
  IniFile := TIniFile.Create(ChangeFileExt(ParamStr(0), '.ini'));
  with IniFile do
    try
